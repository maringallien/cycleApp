...
function CommunityScreen({ onStartDefending }) {
  ...
  if (view === 'report-form') return <ReportForm handleBack={handleBack} onSubmit={submitStolenReport} />
  if (view === 'bike-detail') return <BikeDetail bike={selectedBike} handleBack={handleBack} />
  if (view === 'battle-detail') return <BattleDetail battle={selectedBattle} handleBack={handleBack} onStartDefending={onStartDefending} />
  if (view === 'group-home') {
    return (
      <GroupHome
        group={selectedGroup}
        ...
        {activeTab === 'find-groups' && (
          <div className="space-y-4">
            ...
            {filteredGroups.length === 0 && (
              <EmptyState icon="🕵️" message="No groups found matching your search." />
            )}
        ...
        {activeTab === 'stolen-bikes' && (
          <div className="space-y-4">
            <SearchInput
              ...
              focusRingColor="focus-within:ring-red-500"
            />
            ...
            {filteredStolenBikes.length === 0 && (
              <EmptyState icon="🚲" message="No bikes found matching your search." />
            )}
