...
export default function RouteDetail({ route, handleBack, onStartRoute }) {
  ...
  return (
    <div className="flex flex-col h-full bg-white relative">
      <DetailHeader variant="blue" onBack={handleBack} title="Route Details" elevated />
        ...
        <div className="p-5 space-y-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="bg-gray-50 p-3 rounded-xl border border-gray-100 text-center">
              ...
              <div className={`font-bold ${getDifficultyColor(route.difficulty)}`}>{route.difficulty}</div>
            </div>
            <div className="bg-gray-50 p-3 rounded-xl border border-gray-100 text-center">
